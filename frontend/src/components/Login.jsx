...
function Login() {
    ...
    const handleSubmit = async (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            event.preventDefault();
            try {
                const response = await axios.post('http://localhost:9999/authentication/login', {
    ...
    return (
        <div style={{marginTop: 112, backgroundColor: '#e2c92b'}}>
            <div>
                <Container style={{padding: '0, 12px', backgroundColor: '#e2c92b'}}>
                    <Row style={{
                        ...
                        <div>
                            ...
                            <div style={{display: "flex", marginBottom: 16, justifyContent: 'center'}}>
                                <Image
                                    className="d-block"
                                    src="http://img.zing.vn/upload/gn/source/Gallery/w10.jpg?_gl=1*1my5kq8*_gcl_au*NjExMzcwODA1LjE3Mjc4ODUwNDk.*_ga*MTUzMDI5NjQ4Mi4xNzI3ODg1MDUw*_ga_83M9K3SF93*MTcyNzg4NTA1MC4xLjAuMTcyNzg4NTA1OC4wLjAuNDI2MDY3ODI0"
                                    alt="Second slide"
