    ...
    const handleSubmit = async (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            if (formData.password === formData.retypepass) {
                try {
                    const response = await axios.post('http://localhost:9999/authentication/register', formData);

                    if (response.status === 201) {
                        alert('Registration successful');
                        navigate('/about');  // Redirect to login after successful registration
                    }
                } catch (error) {
                    ...
                    <Row style={{
                        ...
                        <div>
                            ...
                            <div style={{display: "flex", marginBottom: 16, justifyContent: 'center'}}>
                                <Image
                                    className="d-block"
                                    src="https://img.zing.vn/upload/gno/source/Gallery/songlaicamgiac.jpg"
                                    alt="Second slide"
